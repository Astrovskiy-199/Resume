...
window.addEventListener('scroll', function() {
  ...
  for (i=0; i < dinophoto.length; i++) { 
    dinophoto[0].addEventListener('click', function(){  count_of_IMG = 5
        if(count_of_IMG === 5) {
            image_viewBlock.style.display="flex"; image_viewBlock.style.backgroundImage="url('../img/bigPhotoDinoThree.jpg')";  image_viewBlock_button_left.style.display="none"; console.log(count_of_IMG ) ; image_viewBlock_button_right.style.display="flex";
      ...
      dinophoto[1].addEventListener('click', function(){  count_of_IMG = 6
        if(count_of_IMG === 6) {
            image_viewBlock.style.display="flex"; image_viewBlock.style.backgroundImage="url('../img/bigPhotoDinoThree.jpg')";  image_viewBlock_button_left.style.display="flex"; console.log(count_of_IMG ) ; image_viewBlock_button_right.style.display="flex";
      ...
      dinophoto[2].addEventListener('click', function(){  count_of_IMG = 7
        if(count_of_IMG === 7) {
            image_viewBlock.style.display="flex"; image_viewBlock.style.backgroundImage="url('../img/bigPhotoDinoOne.jpg')";  image_viewBlock_button_left.style.display="flex"; console.log(count_of_IMG ) ; image_viewBlock_button_right.style.display="flex";
      ...
      dinophoto[3].addEventListener('click', function(){  count_of_IMG = 8
        if(count_of_IMG === 8) {
            image_viewBlock.style.display="flex"; image_viewBlock.style.backgroundImage="url('../img/bigPhotoDinoFourth.jpg')";  image_viewBlock_button_left.style.display="flex"; console.log(count_of_IMG ) ; image_viewBlock_button_right.style.display="none";
   ...
   var BigPhoto= document.getElementsByClassName('seventhBlockIconsFractionIcon');
    for( i = 0; i < BigPhoto.length; i++){ 
        BigPhoto[0].addEventListener('click', function() { count_of_IMG = 0
        ...
        BigPhoto[1].addEventListener('click', function() { count_of_IMG = 1
        ...
        BigPhoto[2].addEventListener('click', function() { count_of_IMG = 2
        ...
        BigPhoto[3].addEventListener('click', function() { count_of_IMG = 3
        ...
        BigPhoto[4].addEventListener('click', function() { count_of_IMG = 4
    ...
    image_viewBlock_button_left.addEventListener('click', function(){
        ...
        if(count_of_IMG === 6) {
            image_viewBlock.style.display="flex"; image_viewBlock.style.backgroundImage="url('../img/bigPhotoDinoTwo.jpg')";  image_viewBlock_button_left.style.display="flex"; console.log(count_of_IMG ); image_viewBlock_button_right.style.display="flex";
        }
    ...
    image_viewBlock_button_right.addEventListener('click', function(){
        count_of_IMG++; console.log(count_of_IMG );
        ...
        if(count_of_IMG === 5) {
            image_viewBlock.style.display="flex"; image_viewBlock.style.backgroundImage="url('../img/bigPhotoDinoTwo.jpg')";  image_viewBlock_button_left.style.display="none"; console.log(count_of_IMG ); image_viewBlock_button_right.style.display="flex";
        }
